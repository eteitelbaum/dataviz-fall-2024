...
You can make and update multiple reactive values with `reactiveValues()`.
...
<iframe src="https://emmanuelteitelbaum.shinyapps.io/fred_app/" width="80%" height="80%" style="border: none;" data-external="1"></iframe>
